# python3 predict.py --model output/model.pth
...
testData = MultitaskDataset(csv_file=LABEL_DATASET_PATH, root_dir=IMAGE_DATASET_PATH)
...
with torch.no_grad():
    ...
    for (image, mask, label, intensity) in testDataLoader:
